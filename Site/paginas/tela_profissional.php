...
<head>
    ...
    <!--link para o futuro style da pag. profissionais-->
    <link rel="stylesheet" href="../styles/bem-vindo">
    <!--link para futuro style da pag bem vindo-->
</head>

<body>
    <header>
        <nav class="nav">
            <menu id="partes" class="menu"><img src="imagens/icon" alt="Logo do Site" class="logo"> i id="burguer" class
                = "material-symbol-outline"> menu</i>
    ...
    <main>
        <section class="texto">
            <h1>Conheço Nossos Profissionais</h1>
            <h2>e se consulte com médicos especializados em TDAH</h2>
        </section>

        <section class="texto">
            <p> Para localizarmos profissionais perto de você, nos informe:</p>
            <button class="btn" id="localização">Sua localização</button>
        </section>
        ...
        <form id="seachForm">
            <div class="campo">
                ...
                <select id="profissao" name="profissao">
                    ...
                    <option value="Psicólo">Psicólo</option>
    ...
    <section class="texto">
        <p> Gostaria de fazer parte do nosso time de profissionais?
        </p>

        <p>Faça parte da rede de profissionais especializados em TDAH. Ao se inscrever, você terá a oportunidade de se
            conectar com outros especialistas, compartilhar conhecimentos e experiências, e encontrar novas
            oportunidades de trabalho.</p>

        <button class="btn" onclink="window.location.href=' cadastro-profissional.php'">Sou profissional</button>
    </section>
